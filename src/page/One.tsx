...
export default function One() {
    ...
    const conversation: mesage[] = [
        ...
        { speaker: "child", text: "Vâng ạ !", delay: 10.5 },
    ];
    return (
        <div>
            ...
            <div className="relative w-[100vw] bg-red overflow-y-auto overflow-x-hidden flex text-white min-h-[100vh]">
                <div className="mesage tilt-in-fwd-tl w-[30%] h-[100vh]  v">
                    ...
                    <img
                        src={bg16}
                        alt=""
                        className="absolute bottom-10 left-66"
                        width={130}
                    />
                    {/* mẹ */}
                    <div className="mes-mini bounce-in-top">
                        <img
                            src={chat}
                            alt=""
                            className="absolute bottom-110 left-25"
                            width={400}
                        />
                    </div>
                    {/* con */}
                    ...
                    <div className="mes-mini">
                        <div className="text-pink-500 w-90 h-50 absolute bottom-125 left-36 flex flex-col items-center justify-center">
                            {conversation.map(
                                (a, index) =>
                                    a.speaker == "mother" && (
                                        <div
